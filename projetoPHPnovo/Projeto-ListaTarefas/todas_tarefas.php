			...
			<div class="row">
				<div class="col-sm-3 menu">
					<ul class="list-group">
						...
						<li class="list-group-item"><a href="nova_tarefa.php">Novo Compromisso</a></li>
						<li class="list-group-item active"><a href="#">Todos Compromissos</a></li>
					</ul>
				</div>
				...
				<div class="col-sm-9">
					<div class="container pagina">
						<div class="row">
							<div class="col">
								<h4>Todos Compromissos</h4>
								<hr />

								<?php foreach ($tarefas as $indice => $tarefa) { ?>
									<div class="row mb-3 d-flex align-items-center tarefa">
									<div class="col-sm-9" id="tarefa<?= $tarefa->id ?>">
